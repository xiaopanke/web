...
var nativeShare = function (elementNode, config) {
    ...
    var qApiSrc = {
        lower: "http://i0.jrjimg.cn/zqt-red-1000/focus/focus20160421_dingjifenxishi/app/share/qb.js",
    ...
    this.init = function () {
        ...
        if ( (isqqBrowser && !isWeixin) || isucBrowser) {
            ...
            $('.btn_kh').css({'margin-left':'30%','margin-right':'30%'});
        }
    };
