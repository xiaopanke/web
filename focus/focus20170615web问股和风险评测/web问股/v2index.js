...
//点击关注并查看
$('body').delegate('.goflow2','click',function(){
    var o=$(this);
    ($).ajax({
      ...
      success : function(ret) {
         if(ret.retCode==2 || ret.retCode==-3){
            ...
            o.parent('.guanzhu').hide();
            o.parent().parent().find('.content').css('display','inline-block');
            if(o.parent().parent().find('.q-img')){
            	o.parent().parent().find('.q-img').show();
            }
         }else{
								...
								$.each(data.IAData.list, function(idx,obj){
									content.append('<div class="q-block q-ques-item mt20">')
	                                    ...
	                                    if(obj.user.relationStatus==4){ //已关注
											content.append('<div class="q-ques-item-a mt20 middle"><span>'+obj.answerContent+'</span>');
											//填充看张看跌
	                                        ...
	                                        content.append('<div class="q-ques-item-a mt20 middle"><em class="guanzhu">'+obj.userName +' 回答了这个问题，'+'<a href="javascript:;" style="color:#3c9af2;" class="goflow2" data-advisterIld="'+obj.userId+'">关注并查看>></a></em>')
											content.append('<span style="display:none" class="content">'+obj.answerContent+'</span>');
											//填充看张看跌
											if(typeof(obj.riseDrop)!='undefined'){
												if(obj.riseDrop==1){
													content.append('<span class="q-img q-icon-looksgreat" style="margin-left:5px;display:none;"></span>');
												}
												else if(obj.riseDrop==-1){
													content.append('<span class="q-img q-icon-looksbad" style="margin-left:5px;display:none;"></span>');
												}
												else{
													//啥都不做
												}
