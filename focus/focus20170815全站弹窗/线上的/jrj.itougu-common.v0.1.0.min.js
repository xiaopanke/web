...
(function(){
	...
	, URL = {
		...
		,test_type : _itgurl+'/account/getEvaluationResultForTgZone.jspa?version=1'
	}
	,T = {
		 login : {}
		,reg : {}
		...
		,_getHead : function(){
			...
			,usability = { //测评
				init : function( _parent ){ //add 测评
					...
					if(usability.usable){
						usability.usable.unbind('click').bind('click',function(){
							var _user = Member.getUserInfo(),isAdviser = parseInt(_user.isAdviser);
							if(	isAdviser == 1 || isAdviser == 2){
								JRJ.usability.show();
							}else{
								//window.location.href='http://i.jrj.com.cn/home/userSetting/fxcp?ReturnURL='+encodeURIComponent(window.location.href);
								//还得让祥吃看看怎么搞
								if($('.fx_pingche').html()=='风险评测'){
									window.open('http://i.jrj.com.cn/home/userSetting/fxcp?ReturnURL='+encodeURIComponent(window.location.href),'_blank');
								}else{
				...
				,isLogin : function(){ //已登录
					...
					//页面上来时判断是投顾还是用户，然后再请求不同的
					var _user = Member.getUserInfo(),isAdviser = parseInt(_user.isAdviser);
					if(	isAdviser == 1 || isAdviser == 2){//投顾
						$.ajax({
							url : URL.test_type+'&userId='+Member.getUserInfo().userId
							,dataType : 'json'
							,success : function( _data ){
						...
						$.ajax({
							...
							data:{
								passportId:Member.getUserInfo().userId,
								riskID:3
							},
							...
							success: function (v) {
								if(v.retCode==0){
									usability.usable.text(v.riskLevel);
									usability.usable.attr('data-riskLevelCode',v.riskLevelCode);
								}else{
				...
				,update : function(){//更新 测试类型
				    ...
				    window.membership.usability = function (_data) {
						try{
							usability.usable.text(_data.riskInfo.riskLevel||'风险评测');
						}catch(e){
							usability.usable.text('风险评测');
						}
					}
		...
		,init : function(){
			...
			(function () {
			    var menuLeftMapping = [
                    ...
                    { 'portfolio': ['/portfolio/user.jspa', '/portfolio/user11.jspa', '/portfolio/v2/mydyn.jspa', '/portfolio/v2/myfav.jspa', '/portfolio/v3/bookTrade.jspa', '/portfolio/v3/myfav.jspa'] },
                    ...
                    { 'portfolio': ['/portfolio/v3/my.jspa', '/portfolio/v2/my.jspa', '/portfolio/my.jspa'] },
                    ...
                    { 'course': ['/xlive/course/myCourse.jspa'] }
                ],
...
(function () {
    ...
    defaultStyles += ".jrj_sb ul.jrj_sb_tougu_list li a span{ display:inline-block;float:left;height:30px;line-height:30px;padding:3px 0;font-size:14px;overflow:hidden; }";
...
JRJ.usability = {
	...
	show: function( callback ){
		...
		dlgA.standardDialog({
            ...
            width: 790,
            content: '<div class="usability-result"><div class="head">基于您的回答，以下是你的风险等级</div><div class="wrap"><p class="desc"></p><dl class="point clearfix"><dd style="background:#2aebb5;margin-left:-9px;">1</dd><dd style="background:#fea32e;margin-left:230px;">24</dd><dd style="background:#f77052;margin-left:100px;">36</dd><dd style="background:#ea4122;margin-left:95px;">45</dd><dd style="background:#d31f00;margin-left:99px;">58</dd><dd style="background:#d31f00;margin-right:-9px;float:right;">64</dd><dt><img src="http://i0.jrjimg.cn/zqt-red-1000/focus/logo_48_48.png" alt=""><i></i></dt></dl><ul class="type clearfix"><li style="width:37.5%">保守型</li><li>谨慎型</li><li>稳健型</li><li>积极型</li><li style="width:8.5%">激进型</li></ul><p class="buttons"><a class="onemore" href="javascript:;">再测一次</a> <a class="close" href="javascript:;">关闭</a></p></div></div><div class="usability-eval"><div class="head"></div><div class="warp"><dl class="steps clearfix"><dd class="curr"><a data-link="q1" href="javascript:;"></a></dd><dd><a data-link="q2" href="javascript:;"></a></dd><dd><a data-link="q3" href="javascript:;"></a></dd><dd><a data-link="q4" href="javascript:;"></a></dd><dd><a data-link="q5" href="javascript:;"></a></dd><dd><a data-link="q6" href="javascript:;"></a></dd><dd><a data-link="q7" href="javascript:;"></a></dd><dd><a data-link="q8" href="javascript:;"></a></dd><dt></dt></dl><form class="questions"><dl class="q1 curr"><dt>您认为合理的股票每月操作频次(一买一卖计算为二次，且算上加减仓操作)为:</dt><dd><label for="tione1"><i></i>0-8次(低风险)</label><input type="radio" value="1" name="ans1" id="tione1"></dd><dd><label for="tione2"><i></i>8-32次(中风险)</label><input type="radio" value="2" name="ans1" id="tione2"></dd><dd><label for="tione3"><i></i>32次以上(高风险)</label><input type="radio" value="3" name="ans1" id="tione3"></dd></dl><dl class="q2"><dt>您认可的操作风格为:</dt><dd><label for="titwo1"><i></i>中长线 (持仓可)超过半年甚至一年以上)(低风险)</label><input type="radio" value="1" name="ans2" id="titwo1"></dd><dd><label for="titwo2"><i></i>中线(持仓可)超过一个月以上)(中风险)</label><input type="radio" value="2" name="ans2" id="titwo2"></dd><dd><label for="titwo3"><i></i>短线(持仓一)不超过三到五个交易日)(高风险)</label><input type="radio" value="3" name="ans2" id="titwo3"></dd></dl><dl class="q3"><dt>您目前看好的股票的类型为:</dt><dd><label for="tithree1"><i></i>大市值业绩蓝筹股(低风险)</label><input type="radio" value="1" name="ans3" id="tithree1"></dd><dd><label for="tithree2"><i></i>中小市值成长股(中风险)</label><input type="radio" value="2" name="ans3" id="tithree2"></dd><dd><label for="tithree3"><i></i>题材热点，强势股(高风险)</label><input type="radio" value="3" name="ans3" id="tithree3"></dd></dl><dl class="q4"><dt>如果操作股票，您能承受的投资损益是多少?</dt><dd><label for="tifour1"><i></i>30%以上的损失(低风险)</label><input type="radio" value="1" name="ans4" id="tifour1"></dd><dd><label for="tifour2"><i></i>10%-20%的损失(中风险)</label><input type="radio" value="2" name="ans4" id="tifour2"></dd><dd><label for="tifour3"><i></i>小于10(高风险)</label><input type="radio" value="3" name="ans4" id="tifour3"></dd></dl><dl class="q5"><dt>您认为比较合理的一只股票的投资仓位一般为:</dt><dd><label for="tifive1"><i></i>经常1/3仓以下(低风险)</label><input type="radio" value="1" name="ans5" id="tifive1"></dd><dd><label for="tifive2"><i></i>1/3仓－2/3仓(中风险)</label><input type="radio" value="2" name="ans5" id="tifive2"></dd><dd><label for="tifive3"><i></i>经常满仓(高风险)</label><input type="radio" value="3" name="ans5" id="tifive3"></dd></dl><dl class="q6"><dt>您觉得操作过程中什么情况下满仓比较合理?</dt><dd><label for="tisix1"><i></i>基本不满仓，什么情况下都会留一部分资金抵抗风险。(低风险)</label><input type="radio" value="1" name="ans6" id="tisix1"></dd><dd><label for="tisix2"><i></i>一般不满仓，当市场出现阶段性大底时会考虑满仓。(中风险)</label><input type="radio" value="2" name="ans6" id="tisix2"></dd><dd><label for="tisix3"><i></i>看行情，有好机会的满仓也无妨。(高风险)</label><input type="radio" value="3" name="ans6" id="tisix3"></dd></dl><dl class="q7"><dt>您认可下面哪一种证券投资的途径?</dt><dd><label for="tiseven1"><i></i>大部分是通过基础信息(包括但)限于上市公司财报，未来发展预测，资金流动数据等)分析(低风险)</label><input type="radio" value="1" name="ans7" id="tiseven1"></dd><dd><label for="tiseven2"><i></i>大部分是通过技术分析(高风险)</label><input type="radio" value="2" name="ans7" id="tiseven2"></dd><dd><label for="tiseven3"><i></i>上述两者结合，短线靠技术，中长线靠基础分析(中风险)</label><input type="radio" value="3" name="ans7" id="tiseven3"></dd></dl><dl class="q8"><dt>如果遇见当前的股价走势与预期方向严重不符时您觉得如何选择合理?</dt><dd><label for="tieight1"><i></i>基本不在乎短期波动，坚定看好后市发展。(低风险)</label><input type="radio" value="1" name="ans8" id="tieight1"></dd><dd><label for="tieight2"><i></i>观望一段时间，等市场明朗后再决定如何操作。(中风险)</label><input type="radio" value="2" name="ans8" id="tieight2"></dd><dd><label for="tieight3"><i></i>一旦发现不对劲，立即止损(高风险)</label><input type="radio" value="3" name="ans8" id="tieight3"></dd></dl></form><p class="submitbtn"><a href="javascript:;">提交</a></p></div><p class="foot">应证监会要求，证券投资者在进行证券投资前须完成风险承受能力测评；在您选择投资咨询服务之前，我们也建议您做好测评工作，为了更好地了解自身风险偏好和风险承受能力，做出合适的选择。</p></div>',
            okBtnText: "确认",
            cancelBtnText: "取消",
            hasBtn: false,
            hasCloseBtn: true,
	...
	run: function( callback ){
		...
		function showResult(res) {
	        if(res.retCode==1){ //做过测评啦
				ueval.fadeOut(); 
	        	uresult.fadeIn(function(){
	        		var point = res.riskInfo.riskScore;
	        		avatar.animate({'left': (point) * 11.25-20 +'px'}, 1000);
	        	});
	        }else if(res.retCode==2){ //没有做过测评啦
	        	ueval.fadeIn(); 
	        	uresult.fadeOut();
	        }
		...
		$('body').on('click', '.usability-eval .submitbtn>a', function(){
			if( $(this).hasClass('clickable') ) {
				$.ajax({
	                type: 'post',
	                //url: 'mock.json',
	                url: '/account/saveEvaluationForTgZone.jspa?version=1',
	                data: form.serialize(),
	                dataType: 'json',
	                beforeSend: function(){
	                ...
	                success: function(data) {
	                	if(data.retCode==1){//成功
	                    	...
	                    	$('.fx_pingche').html(data.riskInfo.riskLevel);
	                    	callback && callback();
	                	}else{//失败
	                		submitBtn.addClass('clickable').text('提交');
 ...
 */
 var zuoxiajiao={
 	...
 	init:function(){
 		this.getdata();
 		this.createStyle('.zuoxiajiao{overflow:hidden;width:334px;bottom:0; border:3px solid #ff4b24;border-top: 0;left:50%; position: fixed;font-size: 14px;margin-left:160px;background:#fff;z-index:100; }.zuoxiah {text-align: center;color: #fff; line-height: 33px;background:#ff4b24 ;position: relative; cursor: pointer;}.zuoxiah i{background:#fff;right:13px; top:15px;width:15px;height: 3px; position: absolute;}.zuoxiadown .zuoxiah i{width:0;height: 0;border:7px solid #ff4b24;border-bottom:7px solid #fff ;top:6px;overflow: hidden;}.zuoxiaimg img{width:100%;height:90px;vertical-align: top;}.zuoxiad{overflow:hidden;color: #333;}.zuoxiad li{overflow:hidden; margin-left: 14px;}.zuoxiad i{float: left;width:4px;height: 4px;border-radius: 50%;background: #ff4b24;    margin-top: 13px;margin-right: 7px;}.zuoxiad li a{float: left;width:200px;overflow: hidden;text-overflow:ellipsis;white-space: nowrap; line-height: 30px;color: #333;}.zuoxiad ul{float: left;padding:8px 0;height:150px;}.zuoxiad li a:hover{color:#2e7cd7;text-decoration: underline;}.zuoxiacanvas{width:95px; margin-top:20px;margin-right:11px;background:#f8f8f8;float:right; text-align: center; padding-top: 12px;}.zuoxiacanvas div{border:1px solid #000;width:80px;height:80px; margin:0 auto;}.zuoxiacanvas span{color:#ff4b24;display: block;line-height: 30px; font-size: 12px;}.zuoxiacanvas:hover {text-decoration:none;}.zuoxiaqrcode{position:relative;}.zuoxiaqrcode b{position:absolute;width:20px;height:20px;background:url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170523pingce/xiaologo.png);top:30px;left:30px;}')
 		
 		
 	},
 	createhtml:function(){
 		var strdiv='<div class="zuoxiajiao">'
					+'    <div class="zuoxiaup">'
					+'    	<div class="zuoxiah zuoclose">爱投顾推荐<i></i></div>'
					+'    	<div class="zuoxiac">'
					+'    		<a href="'+this.picLinkUrl+'" class="zuoxiaimg zuodadian" target="_blank" dadianname="zuoxiajiao_web_banner" ><img src="'+this.picUrl+'" ></a>'
					+'    	</div>'
					+'    	<div class="zuoxiad">'
					+'    		<ul>'+this.lilist+'</ul>'
					+'    		<a class="zuoxiacanvas" target="_blank" href="http://appcms.jrj.com.cn/download.jspa?channel=Y3493MDZS&tgqdcode=4MQC9TLU">'
					+'    			<div class="zuoxiaqrcode"><img src="http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170304loadding/web/img/zuoxiacode.png"><b></b></div>'
					+'    			<span href="">下载金融界app</span>'
					+'    		</a>'
					+'    	</div>'
					+'    </div>'
					+'    <div class="zuoxiadown zuoopen">'
					+'    	<div class="zuoxiah ">爱投顾推荐<i></i></div>'
					+'    </div>'
					+'</div>'
 		var zuoxiadiv=$(strdiv)
 		zuoxiadiv.appendTo('body');	
 	},
 	createStyle: function( cssText ){
		var zuoxiaStyle = document.getElementById( 'zuoxia' ),
			head = document.getElementsByTagName( 'head' )[0];

		if( !zuoxiaStyle ){
			if( document.addEventListener ){
				zuoxiaStyle = document.createElement('style');
				zuoxiaStyle.type = 'text/css';
				zuoxiaStyle.id = 'zuoxia';
				zuoxiaStyle.media = 'screen';
				head.appendChild( zuoxiaStyle );
				zuoxiaStyle.appendChild(document.createTextNode(cssText));
			} else { //IE7/8
				zuoxiaStyle = document.createElement('div');
				zuoxiaStyle.innerHTML = '_<style type=\"text/css\">' + cssText + '</style>';
				zuoxiaStyle.removeChild(zuoxiaStyle.firstChild);
				head.appendChild(zuoxiaStyle.firstChild);
			}
		}
	},
	goclick:function(){
		$('.zuoxiajiao').delegate('.zuoclose','click',function(){
			$(this).parent().animate({'height':0},200,function(){
				$('.zuoopen').animate({'height':'33px'},200);
			});
			this.zuoxiaopen='no'
			$.Cookie.set( 'zuoxiaopen' , this.zuoxiaopen , true,{expires:1,path:'/', domain:'jrj.com.cn'} ); 
		})
		$('.zuoxiajiao').delegate('.zuoopen','click',function(){
			$(this).animate({'height':0},200,function(){
				$('.zuoxiajiao .zuoxiaup').animate({'height':'290px'},200);
			});
			this.zuoxiaopen='yes'
			$.Cookie.set( 'zuoxiaopen' , this.zuoxiaopen , true ,{expires:1,path:'/', domain:'jrj.com.cn'}); 
		})

		$('.zuoxiajiao').delegate('.zuodadian','click',function(){
			dcsMultiTrack('DCS.dcsuri', $(this).attr('dadianname'), 'WT.ti', $(this).attr('dadianname'));
		})
	},
	chuliyangshi:function(){
		var url=window.location.href;
		if(url=='http://itougu.jrj.com.cn/' || url=='http://itougu.jrj.com.cn'){
			$('.zuoxiajiao').show().css('margin-left','260px')
		}else if(url.indexOf('match')!=-1){
			$('.zuoxiajiao').hide();
		}else{
			$('.zuoxiajiao').show().css('margin-left','160px');
		}
		this.nageshow();
	},
	getdata:function(){
		var _k=this;
		$.ajax({
           url:'http://itougu.jrj.com.cn/xlive/getFragment.jspa',
           dataType : "json",
           success:function(v) {
                if(v.retCode==0){
                	if(v.data.picLinkUrl){
	                	_k.picLinkUrl=v.data.picLinkUrl;
	                	_k.picUrl=v.data.picUrl;
	                	for(var i=0;i<v.data.list.length;i++){
	                		var o=v.data.list[i];
	                		_k.lilist+='<li><i></i><a href="'+o.url+'" target="_blank" class="zuodadian"  dadianname="zuoxiajiao_web_link'+(i+1)+'">'+o.title+'</a></li>'
	                	}
	                	_k.createhtml();
				 		_k.goclick();
				 		
				 		if(!$.cookie('zuoxiaopen')){
				 			$.Cookie.set( 'zuoxiaopen' , _k.zuoxiaopen , true ,{expires:1,path:'/', domain:'jrj.com.cn'}); 
				 		}else{
				 			_k.zuoxiaopen=$.cookie('zuoxiaopen')
				 		}
				 		_k.chuliyangshi();
			 		}
                }
	...
	nageshow:function(){
		if($.cookie('zuoxiaopen')=='yes'){
			$('.zuoxiaup').css('height','290px');
			$('.zuoxiadown').css('height',0);
		}else{
			$('.zuoxiaup').css('height',0);
			$('.zuoxiadown').css('height','33px');
		}
	}
 }
 zuoxiajiao.init();
